...
=============================================================================
 ...
 Features:
   - ViewBox synchronisation so 1 CSS pixel == 1 SVG unit simplifying math.
 ...
 Implementation Notes:
   ...
   - repositionGroupsToAnchors uses instantaneous translation deltas (no tween)
...
export function installLayout(cls) {
  Object.assign(cls.prototype, {
    ...
    attachResize() {
      ...
      // Orientation changes on mobile may happen before the layout has fully
      // settled; run the same handler but give the UA a couple frames to
      // stabilise so view sizes (and getBoundingClientRect) are reliable.
      window.addEventListener('orientationchange', () => {
        // run after two frames to allow orientation/layout to stabilise
